...
public class bayes2Classifier{
    public static void classifier(String sentence) throws IOException {
        ...
        String path = "/Users/gokul-pt1831/Downloads/intern recognition/personDataset.txt";
        ...
        path = "/Users/gokul-pt1831/Downloads/intern recognition/descriptionDataset.txt";
        file = new File(path);
        ...
        path = "/Users/gokul-pt1831/Downloads/intern recognition/reasonDataset.txt";
        file = new File(path);
        reader = new FileReader(file);
        buffer = new BufferedReader(reader);
        while (buffer.read() != -1) {
        ...
        path = "/Users/gokul-pt1831/Downloads/intern recognition/timeDataset.txt";
        file = new File(path);
        reader = new FileReader(file);
        buffer = new BufferedReader(reader);
        while (buffer.read() != -1) {
        ...
        path = "/Users/gokul-pt1831/Downloads/intern recognition/quantityDataset.txt";
        file = new File(path);
        reader = new FileReader(file);
        buffer = new BufferedReader(reader);
        while (buffer.read() != -1) {
        ...
        path = "/Users/gokul-pt1831/Downloads/intern recognition/things.txt";
        file = new File(path);
        reader = new FileReader(file);
        buffer = new BufferedReader(reader);
        while (buffer.read() != -1) {
        ...
        path = "/Users/gokul-pt1831/Downloads/intern recognition/place.txt";
        file = new File(path);
        reader = new FileReader(file);
        buffer = new BufferedReader(reader);
        while (buffer.read() != -1) {
        ...
        while(true) {
            ...
            */
            if (a == 1) {
                ...
                log = new File("/Users/gokul-pt1831/Downloads/intern recognition/personDataset.txt");
                ...
                log = new File("/Users/gokul-pt1831/Downloads/intern recognition/descriptionDateset.txt");
                fileWriter = new FileWriter(log, true);
                bufferedWriter = new BufferedWriter(fileWriter);
                bufferedWriter.write("\n "+unknown1);
                bufferedWriter.close();
                ...
                log = new File("/Users/gokul-pt1831/Downloads/intern recognition/reasonDataset.txt");
                fileWriter = new FileWriter(log, true);
                bufferedWriter = new BufferedWriter(fileWriter);
                bufferedWriter.write("\n "+unknown1);
                bufferedWriter.close();
                ...
                log = new File("/Users/gokul-pt1831/Downloads/intern recognition/timeDataset.txt");
                fileWriter = new FileWriter(log, true);
                bufferedWriter = new BufferedWriter(fileWriter);
                bufferedWriter.write("\n "+unknown1);
                bufferedWriter.close();
                ...
                log = new File("/Users/gokul-pt1831/Downloads/intern recognition/quantityDataset.txt");
                fileWriter = new FileWriter(log, true);
                bufferedWriter = new BufferedWriter(fileWriter);
                bufferedWriter.write("\n "+unknown1);
                bufferedWriter.close();
                ...
                log = new File("/Users/gokul-pt1831/Downloads/intern recognition/things.txt");
                fileWriter = new FileWriter(log, true);
                bufferedWriter = new BufferedWriter(fileWriter);
                bufferedWriter.write("\n "+unknown1);
                bufferedWriter.close();
                ...
                log = new File("/Users/gokul-pt1831/Downloads/intern recognition/place.txt");
                fileWriter = new FileWriter(log, true);
                bufferedWriter = new BufferedWriter(fileWriter);
                bufferedWriter.write("\n "+unknown1);
                bufferedWriter.close();
